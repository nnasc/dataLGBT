...
O pacote é organizado em duas etapas principais:

1.  Vinculação dos bancos: Esta etapa realiza:
...
2.  Processamento epidemiológico Esta etapa gera:
